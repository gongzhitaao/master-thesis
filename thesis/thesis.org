...
* Introduction
  ...
  malls, convention centers, etc.  In addition, indoor spaces are
...
* Preliminary
  ...
  Bayesian filters, including Kalman filter and particle filter, and
  location inference based on the two filters.  Notations used in this
  paper are summarized in Table [[tab:notation]].
