...
*** Dummy                                                             :BMCOL:
    ...
    1. Object are restricted on walking graph for simplicity.
    2. Each object/particle in the candidate set is mapped to the
       nearest /anchor point/.  Information associated with each
...
** Summary
   ...
   4. Through extensive experiment on range query and \(k\)NN, we
